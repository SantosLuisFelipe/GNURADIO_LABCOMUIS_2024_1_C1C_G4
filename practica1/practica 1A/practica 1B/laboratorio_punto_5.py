...
class laboratorio_punto_5(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "practica  1B_p5", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("practica  1B_p5")
        ...
        self.settings = Qt.QSettings("GNU Radio", "laboratorio_punto_5")
...
def main(top_block_cls=laboratorio_punto_5, options=None):
